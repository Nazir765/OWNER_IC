...
try:
    ...
    print '\n [\xc3\x97] The requests module is installed!...\n'
    ...
    def __mbasic__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            if 'c_user' in ses.cookies.get_dict().keys():
                ...
                print '\r%s[ICT-OK]    %s     | %s   %s' % (H, user, pw, N)
                ...
                try:
                    ...
                    print '\r%s[ICT-CP]   %s   | %s | %s %s %s %s' % (K, user, pw, day, month, year, N)
                ...
                print '\r%s[ICT-CP]    %s     | %s %s' % (K, user, pw, N)
